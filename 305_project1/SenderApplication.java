...
public class SenderApplication
{
    ...
    public boolean sendMessage()
    {
    	...
    	index = st.getPkNum(); //get the cur packet to send from the transport layer
    	
 
        return st.sendMessage(new Message(messages.get(index))); //find the msg wanted and send it
